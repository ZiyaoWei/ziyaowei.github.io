...
function octaveRadius(octave) {
  // Lower octaves (bigger, lower-pitched notes) get bigger circles. The spread
  // keeps octaves 2-5 (bass through melody) visually distinct.
  return Math.max(5, 19.5 - octave * 2.5);
}
